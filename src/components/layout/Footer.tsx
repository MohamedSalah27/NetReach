  ...
  return (
    <footer className="w-full border-t border-white/5 bg-[#050508] py-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* سطر واحد متمركز في المنتصف */}
        <div className="flex flex-row items-center justify-center gap-x-8 mb-10">
          ...
          >
            ...
            <span className="border-b border-transparent hover:border-purple-400">Privacy Policy</span>
          </Link>
        ...
        {/* Compliance Text - زي ما هو بالظبط */}
