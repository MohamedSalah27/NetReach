...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full border-t border-white/5 bg-[#050508] py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
          ...
          <p className="text-sm text-slate-600 font-medium">
            © 2026 NetReach. Operational Excellence.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 mb-8">
          <Link
            to="/terms"
            className="flex items-center gap-2 text-slate-500 hover:text-purple-400 transition-colors text-xs uppercase tracking-[0.15em] font-bold group"
          >
